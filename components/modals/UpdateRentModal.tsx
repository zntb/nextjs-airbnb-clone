...
const UpdateRentModal = ({
      ...
      default:
        return (
          <div className="flex flex-col gap-2">
            ...
            />
            <div
              className="flex-1 grid grid-cols-2 gap-3 max-h-[60vh] lg:max-h-[260px] overflow-y-scroll
                scroll-smooth"
            >
              {categories.map((item) => (
                <CategoryButton
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <Modal.WindowHeader title="Update your home!" />
      <form
        className="flex-1 md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full
